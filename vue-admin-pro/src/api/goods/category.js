...
export default {
  ...
  // 排序数据
  sort: data => http.post(BASE_URL + '/sort', data),
  // 批量创建数据
  batch: data => http.post(BASE_URL + '/batch', data),
  // 获取配置数据
  config: data => http.post(BASE_URL + '/config', data),
  // 更新数据
  updateConfig: data => http.post(BASE_URL + '/updateConfig', data)
}
